...
ser = serial.Serial('COM3',512000,parity='E',stopbits=1,timeout=3) #when using serial only
...
##################################################################################################################################
    ...
    def botcon(self):
        ...
        while(ser.readline()!= b'\x58\x75'):
            print("im fucking stuck here : ack1 connectbutton")
            pass
    def botdcon(self):
        ser.write([147,self.checksum([147])[0]])
        while(ser.readline()!= b'\x58\x75'):
            print("im fucking stuck here : ack1 disconnectbutton")
            pass
